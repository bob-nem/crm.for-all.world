...
export default function HowToChoise() {
    return (
        <div className={style.Container} style={{padding: "3%", textAlign: "justify"}}>
            <h1 style={{fontFamily: "Righteous", textTransform: "uppercase", WebkitTextStroke: "1px white", fontSize: "2rem"}}>How to choise ERP system</h1>
            <div className={style.Introduction}>                
                <div className={style.IntroductionP}>
                    <p style={{paddingTop: "1em"}}>...Or maybe you have been working for a long time, but you are just starting your way to automation and technology. In general, the time has come to purchase a tool to reduce costs, increase employee efficiency and full control over all processes in the company.</p>
            ...
            <h2>when you need an ERP system</h2>
            ...
            <h2 style={{paddingTop: "1em"}}>what is important to consider when you decide to implement an ERP system</h2>
            ...
            <h2 style={{paddingTop: "1em"}}>key points that will help you find a suitable ERP system</h2>
            ...
            <h2 style={{paddingTop: "1em"}}>TOTAL:</h2>
