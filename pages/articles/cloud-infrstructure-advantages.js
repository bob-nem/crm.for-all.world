        ...
        <>
            ...
            <div className={style.Content}>
                ...
                <p>Self-service on demand - the consumer, without interaction with a cloud service provider, independently determines their computing needs: the amount of stored data, server time, access speed and data processing;
                    ...
                    Models of "clouds"</p>
                <p>From the point of view of equipment ownership and access provision, "clouds" are divided into three types: public, private and hybrid.</p>
                <p>A public "cloud" is an infrastructure designed for free use by a wide range of customers. The public "cloud" belongs to and physically exists in the jurisdiction of the owner/service provider.</p>
